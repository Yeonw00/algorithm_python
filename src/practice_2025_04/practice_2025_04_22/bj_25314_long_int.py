...
“int 앞에 long을 하나씩 더 붙일 때마다 4바이트씩 저장할 수 있는 공간이 늘어나는 걸까? 분명 long long long int는 12바이트,
...
result = 'int'
multiply = n // 4
print('long ' * multiply + result)

# 만약 코드가 "long"들을 리스트로 다룬 뒤 join() 하고 싶다면, 이렇게도 가능
